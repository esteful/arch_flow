...
plot(ggplot(.datt, aes(x= KILN, y = i, fill=REGION)) + geom_boxplot() )
}
```
...
arch_dendro(df_chem, printDendro = FALSE, nplot=c(2,3))
```
...
arch_PCA(df_chem, lvar=.lvar, nplot=c(2,3)) #nplot is the vector containing categories to be shown
```
