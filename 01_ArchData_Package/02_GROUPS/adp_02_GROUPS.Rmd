...
arch_dendro(df_chem[,-c(7)],printDendro = TRUE, nplot=c(2,3))
```
...
```{r, echo=FALSE}
source('~/Programming/Github/arch_flow/R_fun/entropia02.R')#use in uniformity
source('~/Programming/Github/arch_flow/R_fun/classifica.R')#used in uniformtity
source('~/Programming/Github/arch_flow/R_fun/arch_uniformity.R')#MVC, and CoDa dendros.
arch_uniformity(GR_GLO[,-c(1:3,13)])#Remove categorical columns
```

###Summary table (applied to the GR_GLO dataset)
```{r, echo=FALSE}
source('~/Programming/Github/arch_flow/R_fun/sum_table.R')
require(RcmdrMisc)
